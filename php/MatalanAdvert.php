...
elseif(isset($_POST['submit'])) {
	...
	if(isset($form['callID']) && ($form['callID'] != '')) {
		...
		$matalan->update($DBH, $jobType, $form['advertLocation'], $form['employed'],
							...
							$form['transport'], $form['travel'], $form['age'],
							$form['workTimeMorn'], $form['workTimeEve'], $form['workTimeNight'], $form['workTimeEnds'],
							$form['twelveMonths'], $form['pastMat'], $form['otherPos'], $form['dbs'], $form['reference'], $form['callID']);
		...
		$matalan->insert($DBH, $callID, $jobType, $form['advertLocation'], $form['employed'],
								$form['currentPos'], $form['previousPos1'], $form['previousPos2'],
								$form['currentCompany'], $form['previousCompany1'], $form['previousCompany2'],
								$form['agency1'], $form['agency2'], $form['agency3'],
								$form['agencyName1'], $form['agencyName2'], $form['agencyName3'],
								$form['supervisorName1'], $form['supervisorName2'], $form['supervisorName3'],
								$form['transport'], $form['travel'], $form['salary'], $form['age'],
								$form['workTimeMorn'], $form['workTimeEve'], $form['workTimeNight'], $form['workTimeEnds'],
								$form['twelveMonths'], $form['pastMat'], $form['otherPos'], $form['dbs'], $form['reference']);
		$common->clearReturn($form['page']);
	}
}