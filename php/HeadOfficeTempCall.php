...
if(isset($_POST['recallID'])) {
    ...
    $recall = new Recall();
    $_SESSION['form'] = $recall->headTempRecall($DBH, $_POST['recallID']);
...
elseif(isset($_POST['submit'])) {
    ...
    if(isset($form['callID']) && ($form['callID'] != '')) {
        ...
        $common->callUpdate($DBH, $clientID, $clientNameID, $form['tempID'], $branch['branchID'], $form['contact'], $form['status'], $form['details'], $further, $form['callID']);
