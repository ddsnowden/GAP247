...
if(isset($_POST['recallID'])) {
	...
	$recall = new Recall();
	$_SESSION['form'] = $recall->sickRecall($DBH, $_POST['recallID']);
...
elseif(isset($_POST['submit'])) {
	...
	if(isset($form['callID']) && ($form['callID'] != '')) {
		...
		$sick->sickUpdate($DBH, $form['reason'], $reqDate, $reqTime, $form['callID']);
		...
		$sick->sickInsert($DBH, $callID, $form['reason'], $reqDate, $reqTime);
