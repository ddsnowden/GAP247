...
if(isset($_POST['recallID'])) {
	...
	$recall = new Recall();
	$_SESSION['form'] = $recall->clientIssuesRecall($DBH, $_POST['recallID']);
...
elseif(isset($_POST['submit'])) {
	...
	if(isset($form['callID']) && ($form['callID'] != '')) {
		...
		//$cancel->cancelUpdate($DBH, $form['workerName'], $reqDate, $reqTime, $form['callID']);
		...
		//$cancel->cancelInput($DBH, $callID, $form['workerName'], $reqDate, $reqTime);
