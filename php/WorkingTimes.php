...
if(isset($_POST['recallID'])) {
	...
	$recall = new Recall();
	$_SESSION['form'] = $recall->workingRecall($DBH, $_POST['recallID']);
...
elseif(isset($_POST['submit'])) {
	...
	if(isset($form['callID']) && ($form['callID'] != '')) {
		...
		$working->workingUpdate($DBH, $form['monclient'], $form['montype'], $form['monstart'], $form['monfinish'], $form['tueclient'], $form['tuetype'], $form['tuestart'], $form['tuefinish'], $form['wedclient'], $form['wedtype'], $form['wedstart'], $form['wedfinish'], $form['thuclient'], $form['thutype'], $form['thustart'], $form['thufinish'], $form['friclient'], $form['fritype'], $form['fristart'], $form['frifinish'], $form['satclient'], $form['sattype'], $form['satstart'], $form['satfinish'], $form['sunclient'], $form['suntype'], $form['sunstart'], $form['sunfinish'], $form['callID']);
		...
		$working->workingInsert($DBH, $callID, $form['monclient'], $form['montype'], $form['monstart'], $form['monfinish'], $form['tueclient'], $form['tuetype'], $form['tuestart'], $form['tuefinish'], $form['wedclient'], $form['wedtype'], $form['wedstart'], $form['wedfinish'], $form['thuclient'], $form['thutype'], $form['thustart'], $form['thufinish'], $form['friclient'], $form['fritype'], $form['fristart'], $form['frifinish'], $form['satclient'], $form['sattype'], $form['satstart'], $form['satfinish'], $form['sunclient'], $form['suntype'], $form['sunstart'], $form['sunfinish']);
