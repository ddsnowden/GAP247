										...
										<form>
											<tr>
												<td class="h2" colspan="2">
													<center>Bookings Completed for '.$branch['branchName'].'</center>
												</td>
											</tr>
											<tr>
											...
											<tr>		
												<td style="padding: 0px 3px 3px 0px; font-family: sans-serif; font-size: 14px; width: 200px;">WORKER TYPE:</td>		 <td><p><pre>'.$_SESSION['form']['workerType'].'</pre></p></td>
											</tr>
											<tr>		
												<td style="padding: 0px 3px 3px 0px; font-family: sans-serif; font-size: 14px; width: 200px;">DATE NEEDED:</td>		 <td><p><pre>'.$_SESSION['form']['dateNeeded'].'</pre></p></td>
											</tr>
											<tr>		
												<td style="padding: 0px 3px 3px 0px; font-family: sans-serif; font-size: 14px; width: 200px;">TIME NEEDED:</td>		 <td><p><pre>'.$_SESSION['form']['timeNeeded'].'</pre></p></td>
											</tr>
											<tr>		
												<td style="padding: 0px 3px 3px 0px; font-family: sans-serif; font-size: 14px; width: 200px;" valign="top">DETAILS:</td>           <td style="width: 300px;"><p><pre wrap="" style="white-space: pre-wrap">'.$_SESSION['form']['details'].'</pre></p></td>
											</tr>
											<tr>		
												<td style="padding: 0px 3px 3px 0px; font-family: sans-serif; font-size: 14px; width: 200px;" valign="top">FURTHER ACTIONS:</td>   <td style="width: 300px;"><p><pre wrap="" style="white-space: pre-wrap">'.$_SESSION['form']['further'].'</pre></p></td>
											</tr>
											</form>
										</table>
									</td>
