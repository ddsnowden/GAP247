										...
										<form>	
											<tr>
												<td class="h2" colspan="2">
													<center>Checkins Completed for '.$branch['branchName'].'</center>
												</td>
											</tr>
											<tr>
											...
											<tr>	
												<td style="padding: 0px 3px 3px 0px; font-family: sans-serif; font-size: 14px; width: 200px;">CHECKIN DATE:</td>        	<td><p><pre>'.$_SESSION['form']['dateToCall'].'</pre></p></td>
											</tr>
											<tr>	
												<td style="padding: 0px 3px 3px 0px; font-family: sans-serif; font-size: 14px; width: 200px;">CHECKIN TIME:</td>        	<td><p><pre>'.$_SESSION['form']['timeToCall'].'</pre></p></td>
											</tr>
											<tr>	
