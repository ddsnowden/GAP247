										...
										<table width="100%" border="0" cellspacing="0" cellpadding="1">
											...
											<tr>
												<td class="h2" colspan="2">
													<center>Head Office Calls</center>
												</td>
											</tr>
											<tr>
											...
											<tr>	                                           
												<td style="padding: 0px 3px 3px 0px; font-family: sans-serif; font-size: 14px; width: 200px;">TRYING TO CONTACT:</td>   <td><p><pre>'.$_SESSION['form']['contact'].'</pre></p></td>
											</tr>
											<tr>	                                           
