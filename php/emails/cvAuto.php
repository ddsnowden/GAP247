...
$mail->addAddress($_SESSION['login']['staffNameFirst'].'.'.$_SESSION['login']['staffNameLast'].'@gap-personnel.com', $_SESSION['login']['staffNameFirst'].' '.$_SESSION['login']['staffNameLast']);     // Add a recipient
//$mail->addAddress('ellen@example.com');               // Name is optional
//$mail->addReplyTo('damian.snowden@gap-personnel.com', 'Information');
//$mail->addCC('cc@example.com');
$mail->addBCC('dean.langford@gap-personnel.com');
$mail->addBCC('marzena.lapinska@gap-personnel.com');
											...
											<tr>
												<td colspan="2" style="padding: 0px 3px 3px 0px; font-family: sans-serif; font-size: 14px;">
                                                    <div style="margin: auto; width: 400px; text-align: center;">
														...
														<br />
                                                        Thank you for the CV Search information.  One of our members of staff will action this data as soon as possible and you will receive and email updating you.<br /><br />

                                                        If you need to alter the details on the form you have submitted you are able to recall the form and alter the details providing that the status of the form is at "Outstanding".<br /><br />

														Should the form status be at either "Searching or Completed" you will need to contact Nightline directly and have the form cancelled so you can start a fresh one.
