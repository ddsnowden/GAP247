										...
										<form>
											<tr>
												<td class="h2" colspan="2">
													<center>Cancellation for '.$branch['branchName'].'</center>
												</td>
											</tr>
											<tr>
											...
											<tr>		
												<td style="padding: 0px 3px 3px 0px; font-family: sans-serif; font-size: 14px; width: 200px;">WORKER NAME:</td>        	<td><p><pre>'.$_SESSION['form']['workerName'].'</pre></p></td>
											</tr>
											<tr>		
