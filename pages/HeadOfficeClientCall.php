<?php 
	...
	$headClientData = new HeadOfficeClientCalls();
    //Recall for existing calls
	$recall = $headClientData->recall($DBH);
	$currentPage = "head office client call";
?>
...
<script type="text/javascript">var callType = 'head office client call';</script>
...
<div class="row form">
	<div class="col-sm-8 col-md-8 col-lg-5">
		...
		<form method="POST" action="/assets/php/HeadOfficeClientCall.php" role="form" class="form-horizontal" >
		    <div class="row">
    			...
    			<input class="hidden" type='hidden' name='type' value="head office client call" />
                ...
                <div class="col-sm-10">
                    <select class="form-control input" name='contact'>
                        ...
                        <?php
                            foreach ($headClientData->contacts($DBH) as $key) { 
