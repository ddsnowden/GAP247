<?php 
	...
	require_once $root.'/assets/php/class/Cancellations.class.php';
	$cancelData = new Cancellations();
	//Recall for existing calls
    $recall = $cancelData->recall($DBH);
...
<script type="text/javascript">var callType = 'Cancellations';</script>
<!-- Start main content of the page -->
<div class="row form">
	<div class="col-sm-8 col-md-8 col-lg-5">
        
		<form method="POST" action="/assets/php/Cancellations.php" role="form" class="form-horizontal" >
		    <div class="row">
    			...
    			<input class="hidden" type='hidden' name='type' value="cancellations" />
                ...
                <div class="col-sm-6 labright">
                    <label for="quantity">Temp Name:</label>
                </div>
    	        <div class="col-sm-10">   
    	            <input type='text' class="form-control input letters" name='workerName' value="<?php if (isset($_SESSION['form']['workerName'])) echo htmlspecialchars($_SESSION['form']['workerName'], ENT_QUOTES); ?>" />
            	</div>
