<?php 
	...
	require_once $root.'/assets/php/class/OtherTempIssues.class.php';
	$issuesData = new TempOther();
    //Recall for existing calls
	$recall = $issuesData->recall($DBH);
	$currentPage = "other temp issues";
?>
...
<script type="text/javascript">var callType = 'other temp issues';</script>
...
<div class="row form">
	<div class="col-sm-8 col-md-8 col-lg-5">
		...
		<form method="POST" action="/assets/php/OtherTempIssues.php" role="form" class="form-horizontal" >
		    <div class="row">
    			...
    			<input class="hidden" type='hidden' name='type' value="other temp issues" />
