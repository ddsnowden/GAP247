...
$(function() {
    ...
    // Create the chart
    $('#tempTotalsGraphs').highcharts('StockChart', {
        chart: {
            events: {
                load: function(chart) {
                    this.setTitle(null, {
        ...
        },
        {
            ...
            name: 'Total Matalan Calls',
            data: <?php echo $calls->typeTotal($DBH, $dates, "advert"); ?>,
            pointStart: Date.UTC(2015, 3, 1),
            pointInterval: 24 * 3600 * 1000,
        ...
        },
        {
            ...
            name: 'Total Matalan Calls',
            data: <?php echo $calls->typeTotal($DBH, $dates, "Matalan Advert"); ?>,
            pointStart: Date.UTC(2015, 3, 1),
            pointInterval: 24 * 3600 * 1000,
        ...
        },
        {
            ...
            name: 'Total Sick/Absent Calls',
            data: <?php echo $calls->typeTotal($DBH, $dates, "sickness or absence"); ?>,
            pointStart: Date.UTC(2015, 3, 1),
            pointInterval: 24 * 3600 * 1000,
        ...
        },
        {
            ...
            name: 'Total Temp Issue Calls',
            data: <?php echo $calls->typeTotal($DBH, $dates, "other temp issues"); ?>,
            pointStart: Date.UTC(2015, 3, 1),
            pointInterval: 24 * 3600 * 1000,
        ...
        },
        {
            ...
            name: 'Total Pay Query Calls',
            data: <?php echo $calls->typeTotal($DBH, $dates, "pay queries"); ?>,
            pointStart: Date.UTC(2015, 3, 1),
            pointInterval: 24 * 3600 * 1000,
        ...
        },
        {
            ...
            name: 'Total Working Time Calls',
            data: <?php echo $calls->typeTotal($DBH, $dates, "working times"); ?>,
            pointStart: Date.UTC(2015, 3, 1),
            pointInterval: 24 * 3600 * 1000,
