<?php
	...
	require_once $root.'/assets/php/class/ClientOtherIssues.class.php';
	$clientIssuesData = new ClientOtherIssues();
    //Recall for existing calls
	$recall = $clientIssuesData->recall($DBH);
	$currentPage = "clientotherissues";
?>
...
<script type="text/javascript">var callType = 'client other issues';</script>
...
<div class="row form">
	<div class="col-sm-8 col-md-8 col-lg-5">
		...
		<form method="POST" action="/assets/php/ClientOtherIssues.php" role="form" class="form-horizontal" >
		    <div class="row">
    			...
    			<input class="hidden" type='hidden' name='type' value="client other issues" />
