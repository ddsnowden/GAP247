<?php
	...
	require_once $root.'/assets/php/class/SicknessOrAbsence.class.php';
	$sickData = new sick();
    //Recall for existing calls
	$recall = $sickData->recall($DBH);
	$currentPage = "sickness or absence";
?>
...
<script type="text/javascript">var callType = 'sickness or absence';</script>
...
<div class="row form">
	<div class="col-sm-8 col-md-8 col-lg-5">
		...
		<form method="POST" action="/assets/php/SicknessOrAbsence.php" role="form" class="form-horizontal" >
		    <div class="row">
    			...
    			<input class="hidden" type='hidden' name='type' value="sickness or absence" />
                ...
                <div class="col-sm-10">
                    <select class="form-control input" name="reason" id="reason">
                        <option value="" <?=(isset($_SESSION['form']['reason']) && $_SESSION['form']['reason'] == '' ? 'selected' : '')?>></option>
                        <option value="Sick" <?=(isset($_SESSION['form']['reason']) && $_SESSION['form']['reason'] == 'Sick' ? 'selected' : '')?>>Sickness</option>
                        <option value="Late" <?=(isset($_SESSION['form']['reason']) && $_SESSION['form']['reason'] == 'Late' ? 'selected' : '')?>>Late</option>
                        <option value="Unable To Attend" <?=(isset($_SESSION['form']['reason']) && $_SESSION['form']['reason'] == 'Unable To Attend' ? 'selected' : '')?>>Unable to attend</option>
                        <option value="Other" <?=(isset($_SESSION['form']['reason']) && $_SESSION['form']['reason'] == 'Other' ? 'selected' : '')?>>Other reason</option>
                    </select>
                </div>
